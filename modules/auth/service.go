...
import (
	"authorization/modules/auth/dto"
...
func (s *AuthService) GenerateToken(ctx context.Context, entity models.User) (string, error) {
...
func (s *AuthService) Check(ctx context.Context, username string) (models.User, error) {
...
func (s *AuthService) Login(ctx context.Context, entity models.User) (string, error) {
